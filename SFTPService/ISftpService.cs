...
namespace SFTPService
{
    ...
    public interface ISftpService
    {
        ...
        /// <summary>
        /// upload the remote directory 
        /// </summary>     
        /// <param name="localePath">is the path of the source directory  .</param>
        /// <param name="remotePath">is the path of the destination directory  .</param>
        /// <returns>bool</returns>
